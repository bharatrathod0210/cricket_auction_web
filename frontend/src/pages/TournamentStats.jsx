...
import { FiTrophy, FiTarget, FiTrendingUp, FiUsers, FiAward } from 'react-icons/fi';
...
const TournamentStats = () => {
    ...
    const tabs = [
        { id: 'overview', label: 'Overview', icon: FiTrophy },
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        {tournament?.playerOfTournament && (
            <div style={{ 
                ...
                <FiTrophy style={{ fontSize: '3rem', marginBottom: 12 }} />
